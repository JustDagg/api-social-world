...
exports.userById = (req, res, next, id) => {
    User.findById(id)
        ...
        .select('name email sex nickname city hometown socialNetworkLink university major specialization studyStatus certificate hobby ethnicity religion mobile nationality birthYear created updated about following followers')
        .exec((err, user) => {
            if (err || !user) {
...
exports.allUsers = (req, res) => {
    User.find((err, users) => {
        ...
        .select("name email sex nickname city hometown socialNetworkLink university major specialization studyStatus certificate hobby ethnicity religion mobile nationality birthYear updated created about following followers notificationToken")
